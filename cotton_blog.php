                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    <tr class="accordion-body">
                                                        <td class="col-md-12 border border-dark border-top-0 text-dark">
                                                            कपाशी हे विदर्भातील
                                    ...
                                    <div id="sect6" role="region" aria-labelledby="collapse6id" class="collapse-panel">
                                        <div class="collapse-panel-inner-wrapper content-text">
                                            <table class="table-responsive table border-left border-dark mb-0">
                                                ...
                                                <tr class="">
                                                    <td class="col-md-12 text-dark border border-dark border-top-0">हे
                                                        पीक साधारणपणे ६० ते
                                    ...
                                    <div id="sect7" role="region" aria-labelledby="collapse6id" class="collapse-panel">
                                        <div class="collapse-panel-inner-wrapper content-text">
                                            <table class="table-responsive table border-left border-dark mb-0">
                                                ...
                                                <tr class="">
                                                    <td class="col-md-4 text-dark border border-dark border-top-0"> <a
                                                            href="#"><img class="my-3"
                                    ...
                                    <div id="sect9" role="region" aria-labelledby="collapse6id" class="collapse-panel">
                                        <div class="collapse-panel-inner-wrapper content-text">
                                            <table class="table-responsive table border-left border-dark m-0">
                                                ...
                                                <tr class="">
                                                    <td class=" col-md-4 border border-dark border-top-0  "> <a
                                                            href="#"><img
                                                    ...
                                                    <td class="col-md-8 text-dark border border-dark border-top-0">
                                                        ...
                                                        केल्यास किडींपासून बचाव होतो. अॅझाटोबॅक्टर (२५ ग्रॅम/किलो
                                            ...
                                            <table class="table-responsive border-left border-dark m-0">
                                                ...
                                                <tbody class="">
                                                    <tr class="">
                                                        ...
                                                        <td class="col-md-3 border border-dark"><b>कपाशी: बागायती
                                                            </b><br> संकरित जाती </td>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="col-md-3 border border-dark"><b>संकरीत बीटी कपाशी वाण
                                                    ...
                                                    <tr class="">
                                                        <td class="col-md-1 border border-dark"></td>
                                                        <td class="col-md-3 border border-dark"> २.
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="col-md-1 border border-dark"></td>
                                                        <td class="col-md-3 border border-dark"><b>कपाशी: कोरडवाहू </b>
                                                        </td>
                                                    ...
                                                    <tr class="">
                                                        <td class="col-md-1 border border-dark"></td>
                                                        <td class="col-md-3 border border-dark"> अ) देशी सुधारित जाती
                                                    ...
                                                    <tr class="">
                                                        <td class="col-md-1 border border-dark"></td>
                                                        <td class="col-md-3 border border-dark">ब) अमेरिकन सुधारित जाती.
                                                    ...
                                                    <tr class="">
                                                        <td class="col-md-1 border border-dark"></td>
                                                        <td class="col-md-3 border border-dark">क) देशी संकरित जाती
                                                    ...
                                                    <tr class="">
                                                        <td class="col-md-1 border border-dark"></td>
                                                        <td class="col-md-3 border border-dark"> ड) अमे. संकरित जाती
                                        ...
                                        <div class="collapse-panel-inner-wrapper content-text">
                                            <table class=" table border-left border-dark m-0">
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td class="col-md-3 text-center border border-dark">पेरणीचे वेळेस
                                                    </td>
                                                    <td colspan="2" class="col-md-6 text-center border border-dark">
                                                        उगवणीनंतर</td>
                                                </tr>
                                                <tr class="">
                                                    <td class="col-md-3 border border-top-none border-dark"></td>
                                                    <td class="col-md-3 text-center border border-dark">नत्र : स्फुरद :
                                                        पालाश</td>
                                                ...
                                                <tr class="">
                                                    <td class="col-md-3 border border-top-none border-dark">कपाशी :
                                                        बागायती बीटी कपाशी </td>
                                                    <td class="col-md-3 text-center border border-dark">४० : ६० : ६०
                                                    </td>
                                                    <td class="col-md-3 text-center border border-dark">४०</td>
                                                    <td class="col-md-3 text-center border border-dark">४०</td>
                                                </tr>
                                                <tr class="">
                                                    <td class="col-md-3 border border-top-none border-dark">संकरीत कापूस
                                                    </td>
                                                    <td class="col-md-3 text-center border border-dark">३५ : ५० : ५०
                                                    </td>
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td class="col-md-3 text-center border border-dark">३० : ३० : ३०
                                                    </td>
                                                    <td class="col-md-3 text-center border border-dark">३०</td>
                                                    <td class="col-md-3 text-center border border-dark">-</td>
                                                </tr>
                                                <tr class="">
                                                    <td class="col-md-3 border border-top-none border-dark">देशी सुधारित
                                                        जाती </td>
                                                    <td class="col-md-3 text-center border border-dark">२० : २० : २०
                                                    </td>
                                                    <td class="col-md-3 text-center border border-dark">२०</td>
                                                    <td class="col-md-3 text-center border border-dark">-</td>
                                                </tr>
                                                <tr class="">
                                                    <td class="col-md-3 border border-top-none border-dark">अमेरिकन
                                                        सुधारित जाती</td>
                                                    <td class="col-md-3 text-center border border-dark">३० : ३० : ३०
                                                    </td>
                                                    <td class="col-md-3 text-center border border-dark">३०</td>
                                                ...
                                                <tr class="">
                                                    <td class="col-md-3 border border-top-none border-dark">देशी संकरित
                                                        जाती</td>
                                                    <td class="col-md-3 text-center border border-dark">३० : ३० : ३०
                                                    </td>
                                                    <td class="col-md-3 text-center border border-dark">३०</td>
                                    ...
                                    <div id="sect15" role="region" aria-labelledby="collapse6id" class="collapse-panel">
                                        <div class="collapse-panel-inner-wrapper content-text">
                                            <table class="table-responsive table border-left border-dark m-0">
                                                ...
                                                <tr class=" ">
                                                    <td class="col-md-3 border border-dark">शिफारसीत रासायनिक खत मात्रा
                                                        (किलो)</td>
                                    ...
                                    <div id="sect17" role="region" aria-labelledby="collapse6id" class="collapse-panel">
                                        <div class="collapse-panel-inner-wrapper content-text">
                                            <table class="table-responsive table border-left border-dark m-0">
                                                ...
                                                <tr class="">
                                                    <td class="col-md-3 text-dark border border-dark border-top-0">उगवण
                                    ...
                                    <div id="sect18" role="region" aria-labelledby="collapse6id" class="collapse-panel">
                                        <div class="collapse-panel-inner-wrapper content-text">
                                            <table class="table-responsive table border-left border-dark m-0">
                                                ...
                                                <tr class=" ">
                                                    <td class="col-md-3 border border-dark">कोरडवाहू (संरक्षक ओलीत)
                                                    </td>
                                    ...
                                    <div id="sect19" role="region" aria-labelledby="collapse6id" class="collapse-panel">
                                        <div class="collapse-panel-inner-wrapper content-text">
                                            <table class="table border-left border-dark m-0">
                                                ...
                                                <tr class=" border">
                                                    <td class="col-md-6 border border-dark border-top-0">१० % नत्र आणि
                                                        पालाश ची शिफारसीत मात्र </td>
                                                    <td class="col-md-6 border border-dark border-top-0">पेरणीच्या वेळेस
                                                    </td>
                                                </tr>
                                                <tr class=" border">
                                                    <td class="col-md-6 border border-dark border-top-0">२० % नत्र आणि
                                                        पालाश ची शिफारसीत मात्र </td>
                                                    <td class="col-md-6 border border-dark border-top-0">२० दिवसांनी
                                                    </td>
                                                </tr>
                                                <tr class=" border">
                                                    <td class="col-md-6 border border-dark border-top-0">२५ % नत्र आणि
                                                        पालाश ची शिफारसीत मात्र </td>
                                                    <td class="col-md-6 border border-dark border-top-0">४० दिवसांनी
                                                    </td>
                                                </tr>
                                                <tr class=" border">
                                                    <td class="col-md-6 border border-dark border-top-0">२५ % नत्र आणि
                                                        पालाश ची शिफारसीत मात्र </td>
                                                    <td class="col-md-6 border border-dark border-top-0">६० दिवसांनी
                                                    </td>
                                                </tr>
                                                <tr class=" border">
                                                    <td class="col-md-6 border border-dark border-top-0">२० % नत्र आणि
                                                        पालाश ची शिफारसीत मात्र </td>
                                                    <td class="col-md-6 border border-dark border-top-0">८० दिवसांनी
                                                    </td>
                                                </tr>
                                            </table>
                                ...
                                <th colspan="3" class="bg-secondary text-light text-center mt-5  mb-0 justify-content-center">कपाशीवरील किडी व त्यांचे व्यवस्थापन</th>
                                                ...
                                                <tr class=" border">
                                                    <td style="width:20% !important;"
                                                        class=" text-dark border border-dark border-top-0">कीटक </td>
                                                    <td class=" text-dark border border-dark border-top-0"> लक्षणे </td>
                                                    <td class=" text-dark border border-dark border-top-0">नियंत्रण/उपाय
                                                    </td>
                                                </tr>
                                                <tr class=" border">
                                                    <td class=" text-center text-dark border border-dark border-top-0">
                                                        रसशोषण करणाऱ्या किडी </td>
                                                ...
                                                <tr class=" border">
                                                    <td class=" text-dark border border-dark border-top-0">१) तुडतुडे
                                                    </td>
                                                ...
                                                <tr class=" border">
                                                    <td class=" text-dark border border-dark border-top-0">३) फुलकिडे
                                                    </td>
                                                ...
                                                <tr class=" border">
                                                    <td class=" text-dark border border-dark border-top-0">४) पांढरी
                                                        माशी </td>
                                                ...
                                                <tr class=" border">
                                                    <td class=" text-dark border border-dark border-top-0">५) पिठ्या
                                                        ढेकूण (मिली बग) </td>
                                                    ...
                                                    <td class=" text-dark border border-dark border-top-0">१) कपाशी
                                                        ...
                                                        कीटक अॅनॅशीयस प्रजाती इ. ची पूरेशी संख्या आढळून आल्यास, रासायनिक
                                    ...
                                    <div id="sect21" role="region" aria-labelledby="collapse6id" class="collapse-panel">
                                        <div class="collapse-panel-inner-wrapper content-text">
                                            <table class="table-responsive table border-left border-dark m-0">
                                                ...
                                                <tr class=" border">
                                                    <td class="col-md-3 text-dark border border-dark border-top-0">१)
                                                        ठिपक्याची बोंडअळी</td>
                                                    <td class="col-md-9 text-dark border border-dark border-top-0">
                                                ...
                                                <tr class=" border">
                                                    <td class="col-md-3 text-dark border border-dark border-top-0">२)
                                                        हिरवी बोंडअळी</td>
                                                ...
                                                <tr class=" border">
                                                    <td class="col-md-3 text-dark border border-dark border-top-0">३)
                                                        गुलाबी बोंडअळी</td>
                                                    <td class="col-md-9 text-dark border border-dark border-top-0">
                                                ...
                                                <tr class=" border">
                                                    <td class="col-md-3 text-dark border border-dark border-top-0">
                                                        कपाशीवरील गुलाबी बोंडअळीचे एकात्मिक व्यवस्थापन (IPM)</td>
                                                    <td class="col-md-9 text-dark border border-dark border-top-0"> १.
                                                ...
                                                <tr class=" border">
                                                    <td class="col-md-3 text-dark border border-dark border-top-0">
                                                        रासायनिक किटकनाशके</td>
                                                    <td class="col-md-9 text-dark border border-dark border-top-0">
                                                        गुलाबी बोंडअळी आर्थिक नुकसान संकेत पातळी गाठल्यास रासायनिक
                                                        किटकनाशकांचा वापर करावा. त्यामधये क्विनॉलफॉस २५ टक्के ए एफ २५
                                    ...
                                    <div id="sect22" role="region" aria-labelledby="collapse6id" class="collapse-panel">
                                        <div class="collapse-panel-inner-wrapper content-text">
                                            <table class="table-responsive table border-left border-dark m-0">
                                                ...
                                                <tr class=" border">
                                                    <td class="col-md-12 text-dark border border-dark border-top-0"> १.
                                                ...
                                                <tr class=" border">
                                                    <td
                                                        class="col-md-12 text-dark border border-dark border-top-0 text-bold">
                                        ...
                                        <div class="collapse-panel-inner-wrapper content-text">
                                            <table class="table-responsive table border-left border-dark m-0">
                                                ...
                                                <tr class=" border">
                                                    ...
                                                    <td class="col-md-4 text-dark border border-dark border-top-0"> • हा
                                                        रोग लॅन्थोमोनास ऑक्झॉनोपोडीस पॅथोव्होर मालवासियारम या
                                                        अणुजीवामुळे होतो. <br>
                                                    ...
                                                    <td class="col-md-6 text-dark border border-dark border-top-0">१)
                                                ...
                                                <tr class=" border">
                                                    ...
                                                    <td class="col-md-4 text-dark border border-dark border-top-0"> • या
                                            ...
                                            <table class="table-responsive table border border-dark m-0">
                                                ...
                                                <tr class=" border">
                                                    ...
                                                    <td class=" text-dark border border-dark border-top-0"> बोंडावरील
                                                        ...
                                                        घटकांमुळे आंतरीक बॉड सडण्याची समस्या दिसून येते. बोंडाच्या बाह्य
                                                ...
                                                <tr class=" border">
                                                    <td class=" text-dark border border-dark border-top-0"> बॉडसड
                                                ...
                                                <tr class=" border">
                                                    <td class=" text-dark border border-dark border-top-0">
                                                        अॅझोक्सिस्ट्रॉबीन (१८.२% डब्ल्यु/डब्ल्यू) + डायफेनोकोनॅझोल
                                                        (११.४% एस.सी.) किंवा
                                                    </td>
                                                    <td class=" text-dark border border-dark border-top-0"> १० मि.ली.
                                                    </td>
